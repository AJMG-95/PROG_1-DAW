...
def cambiar_dni_segun_factura(raiz):
    numero = input('Introduzca el número de factura del cliente: ')
    nuevo_dni = input('Introduzca el nuevo DNI del cliente: ')
    for dni in raiz.findall(f'./factura[@numero="{numero}"]/cliente/dni'):
        print(f'Encontrado cliente con DNI {dni.text}')
        dni.text = nuevo_dni
...
while True:
    ...
    if opcion == '1':
        ...
        cambiar_dni_segun_factura(raiz)
    elif opcion == '9':
