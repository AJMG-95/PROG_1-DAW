...
public class Principal {
    public static void main(String[] args) {
        ...
        assert (new Lampara(3, 2, 20)).poner(new Bombilla(10, Tamanyo.PEQUENYO))
                .poner(new Bombilla(10, Tamanyo.MEDIANO)).quitar(Tamanyo.MEDIANO).getTamanyo() == Tamanyo.MEDIANO;
    }
}
