package EXAMANES_P_A_J.Televisor;
...
public class Principal {
    public static void main(String[] args) {
        ...
        assert (new Televisor()).conectar(soporte).encender().reproducirSiConectado()
                .equals(new HashSet<String>(List.of("Batman.mp4", "Superman.mp4")));
    }
}
